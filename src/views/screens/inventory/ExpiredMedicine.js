...
function ExpiredMedicine() {
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(
      "<html><head><title>Expiry Data Management</title></head><body>"
    );
    printWindow.document.write("<h1>Expiry Data Management</h1>");
  ...
  const handleExportCSV = () => {
    ...
    link.href = csvUrl;
    link.setAttribute("download", "ExpiryData.csv");
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(workbook, "ExpiryData.xlsx");
  };
